...
const STATUS_ORDER: Record<CallCenterAgentDTO["status"], number> = {
  onCall: 0,
  available: 1,
  offline: 2,
};
    ...
    <div className="rounded-lg border border-slate-200 bg-white">
      ...
      {sorted.length === 0 ? (
        <div className="p-8 text-center text-sm text-slate-400">
          No confirmation agents on this team yet.
        </div>
      ) : (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-0.5 flex items-center gap-1.5">
                    ...
                    <span
                      className={clsx("text-[11.5px] font-medium", meta.text)}
                    >
                      {meta.label}
                    </span>
                ...
                <div className="hidden shrink-0 gap-4 text-right text-[11px] text-slate-500 sm:flex">
                  ...
                  <div>
                    <p className="font-semibold tabular-nums text-slate-800">
                      {formatMinutes(agent.avgTimeToConfirmMinutes)}
                    </p>
