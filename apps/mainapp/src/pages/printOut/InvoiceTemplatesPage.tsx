...
const SAMPLE_ORDER: OrderDTO = {
  ...
  priorityNote: null, isCustomerBlocked: false, isReturningCustomer: false, isFraudAlert: false, steadfastFraudCheck: null, pathaoFraudCheck: null, courierPartner: 'Steadfast', courierTrackingId: 'STF12345678',
