            ...
            {filteredPurchaseOrders.length === 0 ? (
              ...
              <>
                ...
                <div className="space-y-2.5 p-3 lg:hidden">
                  {filteredPurchaseOrders.map((po) => (
                    <div key={po.id} className="zs-surface p-3.5">
                      ...
                      <div className="mt-3 flex items-center justify-between gap-2 border-t border-slate-100 pt-3">
                        ...
                        <button
                          onClick={() => setPrintingPo(po)}
                          className="flex h-8 items-center gap-1.5 rounded-lg border border-slate-200 px-2.5 text-xs font-semibold text-slate-700 hover:bg-slate-50"
                        >
                          <Printer size={13} /> Print
                        </button>
                      </div>
          ...
          <section className="min-w-[900px]">
            {filteredOrders.length === 0 ? (
              ...
              <>
                ...
                <div className="space-y-2.5 p-3 lg:hidden">
                  {filteredOrders.map((order) => (
                    <div key={order.id} className="zs-surface p-3.5">
                      <div className="flex items-start justify-between gap-2">
                        <div className="flex min-w-0 items-start gap-2.5">
                          <input
                            type="checkbox"
...
const PREVIEW_ORDER: OrderDTO = {
  ...
  hasUnusualQuantity: false,
  quantityFlagAcknowledged: false,
  riskLabel: null,
