...
export function ChannelOverviewCard({ store }: { store: StoreDTO }) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 zs-surface p-4">
      <div className="flex min-w-0 items-center gap-3">
        <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-slate-50 ring-1 ring-slate-200">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-0.5 text-xs text-slate-400">
            {store.productCount.toLocaleString()} products &middot;{" "}
